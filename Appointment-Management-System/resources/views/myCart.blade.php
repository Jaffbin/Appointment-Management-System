...
<form action="{{route('payment.post')}}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="ppk_test_51QZ1BpEllOw6mJdp5DE5PdQhfnK63gp6bOaVSYHiFxJfmFmz1rKDFQKPShuGMs5mgHEAdE4TKYDCMwzoAubia7h400xHQX8iuv" id="payment-form">  
   @csrf
<div class="row">
